                            ...
                            '<div class="container">' +
                                ...
                                '<div class="content-box">' +
                                    '<div class="arrow">' +
                                        ...
                                        '<span class="prev-btn {delegate_click}" title="上月"><img src="images/m_back1.png" /></span>' +
                                        '<span class="next-btn {delegate_click}" title="下月"><img src="images/m_next1.png" /></span>' +
                                    '</div>' +
                                    '<div class="date-box">' +
                                        '{date_template}' +
                                    '</div>' +
